    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6 col-lg-3">
                <div class="logo"><a href="{{route('/')}}"><img src="{{asset('frontEndAsset')}}/images/logo/logo.png" alt="JobHere"></a></div>
            </div>
            <div class="col-sm-6 col-lg-9">
                <div class="pull-right header-menu">
                    <nav id="primary-menu">
                        <ul class="main-menu text-right">
                            ...
                            <li><a href="{{route('job-board')}}">Jobs</a>
                                <ul class="dropdown">
                                    <li><a href="{{route('single-job')}}">Single Job </a></li>
                    ...
                    <div class="login-btn">
                        <a class="modal-view button" href="{{route('register')}}" data-bs-toggle="modal" data-bs-target="#register">Register</a>
                        <a class="modal-view button" href="{{route('login')}}" data-bs-toggle="modal" data-bs-target="#productModal">Login</a>
                    </div>
                </div>
            </div>
        </div>
